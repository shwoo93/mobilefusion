...
namespace MobileFusion {
    ...
    void CloudCompareRenderer::onCloudFrame(pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_targetDownsampled, pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_source_registered) {
        pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBNormal> single_color_1(cloud_targetDownsampled, 255, 0 , 0);
        pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZRGBNormal> single_color_2(cloud_source_registered, 0, 255, 0);
